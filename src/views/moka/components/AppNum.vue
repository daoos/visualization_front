...
<script>
  ...
  import { getApplicationCount } from '@/api/moka'
  export default {
    props: {
      className: {
        type: String,
    ...
    methods: {
      getApplicationCount() {
        this.normalCount = []
        this.exceptionCount = []
        getApplicationCount().then(respose => {
          var res = respose.data
          var judicialApp = res.judicialApp
          var peopleApp = res.peopleApp
          var trialApp = res.trialApp
          this.exceptionCount.push(trialApp.exceptionCount, judicialApp.exceptionCount, peopleApp.exceptionCount)
          this.normalCount.push(trialApp.normalCount, judicialApp.normalCount, peopleApp.normalCount)
        })
      },
      initChart() {
